const cmdSocketURI = 'ws://192.168.1.24:9997/cmd';
const srSocketURI = 'ws://192.168.1.24:10003/sr';
const msgSocketURI = 'ws://192.168.1.24:10004/msg';
const hsSocketURI = 'ws://192.168.1.24:10000/hs';
...
srScoket.onclose = function(e) {
  console.log('connection closed sr (' + e.code + ')');
};
...
commanderSocket.onclose = function(e) {
  console.log('connection closed hs (' + e.code + ')');
};
