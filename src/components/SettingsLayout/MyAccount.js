    ...
    <div className='modal-my-account-container'>
      ...
      <div className='modal-my-account-info-container'>
        <div className='modal-my-account-info-section'>
          ...
          <span className='modal-modal-my-account-text'>{settings['myInfo'] && settings['myInfo'].username}</span>
          {openEdit ? (
        ...
        <div className='two-text-group'>
          <div className='modal-my-account-info-section'>
            ...
            <span className='modal-modal-my-account-text'>{settings['myInfo'] && settings['myInfo'].ip}</span>
          </div>
          <div className='modal-my-account-info-section'>
            <span className='modal-modal-my-account-title'>Mac ADDRESS</span>
            <span className='modal-modal-my-account-text'>{settings['myInfo'] && settings['myInfo'].mac}</span>
          </div>
        </div>
      </div>
    </div>
